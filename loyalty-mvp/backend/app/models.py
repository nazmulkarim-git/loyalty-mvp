from sqlalchemy import Column, String, Boolean, Integer, DateTime, ForeignKey, Text, Date, CheckConstraint
...
class Redemption(Base):
    ...
    id: Mapped[str] = mapped_column(String, primary_key=True, default=uuid4_str)
    enrollment_id: Mapped[str] = mapped_column(String, ForeignKey("enrollments.id"))
    status: Mapped[str] = mapped_column(String, nullable=False, default="requested")  # requested/approved/declined/expired
